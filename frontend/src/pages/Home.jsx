      ...
      <Container maxWidth="lg" sx={{ 
        ...
        <Box sx={{ 
          ...
          {[
            { 
              title: 'База Данных',
              content: 'Интеграция MongoDB в качестве базы данных',
              icon: '✨'
            },
            { 
              title: 'Информация',
              content: 'LLM модель для ответов на сообщения пользователя. Созданная и обученная Денисом Русиновым в рамках дисциплины Управление Данными',
              icon: '🔒'
            },
            { 
              title: 'Технологии', 
